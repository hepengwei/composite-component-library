...
const Forecast4 = () => {
  ...
  const createNumberList = (
    ...
    let numberList: string[] = redMoreSortData
      .slice(0, 3)
      .concat(redLessSortData.slice(0, 3))
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        <div style={{ marginRight: "12px" }}>
          ...
          计算出近10期开奖号码中出现红球号码最多的前6个号码,取前3个号码，再计算出近10期开奖号码中出现红球号码最少的前6个号码，取前3个号码，以次取到6个号码作为预测的红球号码；计算出近10期开奖号码中出现蓝球号码最多的前6个号码，取第1个号码作为预测的蓝球号码；最后给红球去重，不够的随机生成号码
        </div>
